...
namespace Academy.DataContext.Migrations
{
    ...
    [Migration("20181030072447_FUASP")]
    partial class FUASP
    {
            ...
            modelBuilder.Entity("Academy.Data.Role", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ConcurrencyStamp = "8057c051-6d39-4caf-af0a-ba496fe01a1a", Name = "Administrator", NormalizedName = "ADMINISTRATOR" },
                        new { Id = 2, ConcurrencyStamp = "4584e033-713d-4589-b2d2-0a71e69ac806", Name = "Teacher", NormalizedName = "TEACHER" },
                        new { Id = 3, ConcurrencyStamp = "54d58670-75e7-4130-8647-1a26a6784953", Name = "Student", NormalizedName = "STUDENT" }
                    );
                });
