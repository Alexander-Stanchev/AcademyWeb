...
namespace Academy.DataContext.Migrations
{
    ...
    [Migration("20181029133059_RolesAdded3")]
            ...
            modelBuilder.Entity("Academy.Data.Role", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ConcurrencyStamp = "62211c1d-7a2a-415d-8a23-5db3ec7311eb", Name = "Administrator" },
                        new { Id = 2, ConcurrencyStamp = "e52357fd-9db6-42aa-87b8-c8a0276e1021", Name = "Teacher" },
                        new { Id = 3, ConcurrencyStamp = "fcd328d4-3f51-4f29-a41b-bc82b79dfdfa", Name = "Student" }
                    );
                });
